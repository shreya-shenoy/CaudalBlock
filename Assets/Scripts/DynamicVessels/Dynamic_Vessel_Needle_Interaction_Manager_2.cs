...
public class Dynamic_Vessel_Needle_Interaction_Manager_2 : MonoBehaviour
{
    DynamicVessel OriginalDV;
    public GameObject DeformableVein { get; private set; }
    DynamicVessel deformableDV = null;
    [SerializeField]
    ...
    static GameObject artery1;
    static GameObject artery2;
    static GameObject artery3;
    ...
    private void Start()
    {
        ...
        OriginalDV = GetComponent<DynamicVessel>();
        DeformableVein = new GameObject("Deformable Vein " + name.Substring(name.Length - 1));

        //if (int.Parse(name.Substring(name.Length - 1)) == 1 ||
        //    int.Parse(name.Substring(name.Length - 1)) == 2 ||
        //    int.Parse(name.Substring(name.Length - 1)) == 3 ||
        //    int.Parse(name.Substring(name.Length - 1)) == 4 ||
        //    int.Parse(name.Substring(name.Length - 1)) == 5 ||
        //    int.Parse(name.Substring(name.Length - 1)) == 6 ||
        //    int.Parse(name.Substring(name.Length - 1)) == 7)
        //{
        //    DeformableVein.tag = "HandVein";
        //}
        ...
        //SMMARTS_SDK.Ultrasound.UltrasoundMaterial.color = RelativeJoint2D;
        //if ((IV_Manager.currentOrientation == (IV_Manager.ARM_ORIENTATION)1) && (GameObject.Find("Deformable Vein 8") || GameObject.Find("Deformable Vein 9")) || ((IV_Manager.currentOrientation == (IV_Manager.ARM_ORIENTATION)1) && GameObject.Find("Deformable Vein y")))
        
            //MeshRenderer ns = DeformableVein.AddComponent<MeshRenderer>();
        //DeformableVein.GetComponent<MeshRenderer>().material.color = Color.red;
       /* if (IV_Manager.currentOrientation == (IV_Manager.ARM_ORIENTATION)1)
        {
            artery1 = GameObject.Find("Deformable Vein 8");
            artery2 = GameObject.Find("Deformable Vein 9");
            MeshRenderer ns = artery1.AddComponent<MeshRenderer>();
            MeshRenderer nr = artery2.AddComponent<MeshRenderer>();
            artery1.GetComponent<MeshRenderer>().material.color = Color.red;
            artery2.GetComponent<MeshRenderer>().material.color = Color.red;
            artery1.layer = LayerMask.NameToLayer("Artery");
            artery2.layer = LayerMask.NameToLayer("Artery");

            //GameObject.Find("Deformable Vein 8").GetComponent<MeshRenderer>().material.color = Color.red;
            //GameObject.Find("Deformable Vein 9").GetComponent<MeshRenderer>().material.color = Color.red;
            //GameObject.Find("Deformable Vein 8").layer = LayerMask.NameToLayer("Artery");
            //GameObject.Find("Deformable Vein 9").layer = LayerMask.NameToLayer("Artery");

        }
        if (IV_Manager.currentOrientation == (IV_Manager.ARM_ORIENTATION)2)
        {
            artery3 = GameObject.Find("Deformable Vein y");
            MeshRenderer nt = artery3.AddComponent<MeshRenderer>();

            artery3.GetComponent<MeshRenderer>().material.color = Color.red;
            artery3.layer = LayerMask.NameToLayer("Artery");


            //GameObject.Find("Deformable Vein y").GetComponent<MeshRenderer>().material.color = Color.red;
            //GameObject.Find("Deformable Vein y").layer = LayerMask.NameToLayer("Artery");
        }*/
    ...
    private void Update()
    {
        ...
        if (IV_Manager.currentOrientation == (IV_Manager.ARM_ORIENTATION)2)
        {
            ...
            //artery3 = GameObject.Find("Deformable Vein b");
            //artery3.tag = "VeinHand";
            //try
            //{
            //    GameObject.Find("Deformable Vein 1").tag = "VeinHand";
            //    GameObject.Find("Deformable Vein 2").tag = "VeinHand";
            //    GameObject.Find("Deformable Vein 3").tag = "VeinHand";
            //    GameObject.Find("Deformable Vein 4").tag = "VeinHand";
            //    GameObject.Find("Deformable Vein 5").tag = "VeinHand";
            //    GameObject.Find("Deformable Vein 6").tag = "VeinHand";
            ...
            //artery3 = GameObject.Find("Deformable Vein 4");
            //artery3.tag = "VeinHand";
            //artery3 = GameObject.Find("Deformable Vein 5");
            //artery3.tag = "VeinHand";
            //artery3 = GameObject.Find("Deformable Vein 2");
            //artery3.tag = "VeinHand";
            //artery3 = GameObject.Find("Deformable Vein 3");
            //artery3.tag = "VeinHand";
            //artery3 = GameObject.Find("Deformable Vein 1");
            //artery3.tag = "VeinHand";


            //this is artery
            //also was originally b not y
            //artery3 = GameObject.Find("Deformable Vein y");
            //artery3.tag = "VeinHand";
            artery3 = GameObject.Find("Deformable Vein 4");
            artery3.tag = "VeinHand";
    ...
    void CloneDV()
    {
        deformableDV = DeformableVein.AddComponent<DynamicVessel>();
        AssignOriginal();
    }
    void AssignOriginal()
    {
        ClearDeformationNodes();
        deformableDV.Segments = new DynamicVessel.VesselSegment[OriginalDV.Segments.Length];
        deformationNodes = new GameObject[OriginalDV.Segments.Length];
        for (int x = 0; x < deformableDV.Segments.Length; x++)
        {
            deformableDV.Segments[x] = new DynamicVessel.VesselSegment(OriginalDV.Segments[x]);
    ...
    void UpdateDeformedVein()
    {
        ...
        deformableDV.Segments = new DynamicVessel.VesselSegment[deformationNodes.Length];
        for (int x = 0; x < deformableDV.Segments.Length; x++)
        {
            deformableDV.Segments[x] = new DynamicVessel.VesselSegment(deformationNodes[x].transform.localScale.x,
