...
[System.Serializable]
public class LogInEditor_Mgr : EditorWindow
{
    ...
    [MenuItem("CSSALT/Log-In Page Preferences %P")]


    static void Init()
    {
        // Get existing open window or if none, make a new one:
        LogInEditor_Mgr window = (LogInEditor_Mgr)GetWindow(typeof(LogInEditor_Mgr));
        window.Show();
    }
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("Log-In Settings", EditorStyles.boldLabel);
        ...
        //newSwitchButtonStatus = EditorGUILayout.Toggle("Using multiple anatomical blocks?", isUsingSwitchButton);
        ...
        if (newSwitchButtonStatus != isUsingSwitchButton)
        {
            if (newSwitchButtonStatus)
            {
